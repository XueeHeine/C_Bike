            ...
            <div data-options="region:'west',title:'导航栏',split:true,width:240,iconCls:'icon-large-smartart'">
                <%--导航的--%>
                    ...
                    <div id="aa" class="easyui-accordion" data-options="fit:true" style="width:300px;height:200px;">
                        ...
                        <div title="维修管理" data-options="iconCls:'icon-man'" style="padding:10px;">
                            <ul class="easyui-tree">
                                <li><a  class="opts" url="/mission/addAndUpdate">新增任务</a></li>
                                <%--<li><a  class="opts" url="/mission/addMan">分配人员</a></li>--%>
                                <li><a  class="opts" url="/mission/list">任务列表</a></li>
                                <li><a  class="opts" url="/mission/list2">我的维修服务</a></li>
                                <li><a  class="opts" url="/mission/map">我的地图</a></li>
                            </ul>
                        </div>
